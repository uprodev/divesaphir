<?php
$features_title = get_field('cuisine_onboard_title');
$features_labels = get_field('cuisine_onboard_labels');
$features_image_gallery = get_field('cuisine_onboard_image_gallery');
?>
<section class="round-slider-wrap round-item-9">
