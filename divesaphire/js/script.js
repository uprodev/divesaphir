jQuery(document).ready(function ($) {
  ...
  $(document).on('click', '.board-wrap .dot', function (e){
    ...
    if($('.tour-table .slider-wrap:nth-child(3)').length>0){
      var top = $('.tour-table .slider-wrap:nth-child(3)').offset().top;
...
//TABS
  ...
  if(strUrl===ulrPar){
    $('.tabs-wrap .tabs-menu li').removeClass('is-active');
    $('.tabs-wrap .tabs-menu li:nth-child(2)').addClass('is-active');
    $('.tabs-wrap .tab-item').hide();
    $('.tabs-wrap .tab-item:nth-child(2)').show();
  }
  ...
  $(document).on('click', '.sub-menu a', function (e) {
    ...
    if(id===ulrPar){
      ...
      $('.tabs-wrap .tabs-menu li').removeClass('is-active');
      $('.tabs-wrap .tabs-menu li:nth-child(1)').addClass('is-active');
      $('.tabs-wrap .tab-item').hide();
      $('.tabs-wrap .tab-item:nth-child(1)').show();
    }
  });
});